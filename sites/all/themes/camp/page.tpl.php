...
<head>
  ...
  <![endif]-->
  <!--[if IE 7]>
  <style type="text/css" media="all">@import "/<?php print $directory; ?>/css/ie7.css";</style>
  <![endif]-->
</head>
      ...
      <div id="page"><div id="page-inner">
        ...
        <div id="header"><div id="header-inner" class="clear-block">
          ...
          <?php if ($site_name): ?>
            <div id="logo-title">
              ...
              <div id="user-registration-badge" class="<?php print $user_is_registered_class?>">
                <?php print $user_registration_badge ?>
              </div>
          

              <?php if ($site_name): ?>
                <div id="logo"><a href="<?php print $front_page; ?>" title="<?php print $site_name ?>" rel="home" class="button logo"><?php print $site_name ?></a></div>
              <?php endif; ?>
        ...
        <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
          ...
          <div id="content"><div id="content-inner">
            ...
            <?php if ($breadcrumb || $title || $tabs || $help || $messages || $content_top): ?>
    ...
    <div id="footer"><div id="footer-inner" class="region region-footer">
      ...
      <?php if ($bottom_left || $bottom_center || $bottom_right): ?>
        <div id="bottom" class="clear-block">
          <div id="bottom-left"><?php echo $bottom_left ?></div>
          <div id="bottom-center"><?php echo $bottom_center ?></div>
          <div id="bottom-right"><?php echo $bottom_right ?></div>
        </div>
      <?php endif ?>
