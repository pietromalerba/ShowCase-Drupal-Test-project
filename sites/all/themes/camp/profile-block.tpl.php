 ...
 */
 ...
 $filepath = $account->picture ? $account->picture : variable_get('user_picture_default', '');
 
?>
<?php print l(theme('imagecache', 'profile-picture', $filepath), 'user/'. $account->uid, array('html' => TRUE)); ?>
